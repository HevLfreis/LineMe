(function () {
    ...
    VIZ.drawElements = function (layeredData) {
        ...
        var margin = {top: 17, right: 0, bottom: 16, left: 20},
            ...
            visHeight = height * 0.8 - margin.top - margin.bottom,
            radius = 2;
    ...
    document.getElementById('layer').appendChild(renderer.domElement);
    ...
    document.getElementById('layer').addEventListener('mousewheel', function(event) {
